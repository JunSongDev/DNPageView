...
- (void)addConstraintsForSuper {
    ...
    [self.logoImageView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.width.height.mas_offset(SCREEN_W*0.3);
    }];
    
    [self.titleLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerX.mas_equalTo(self);
        make.top.mas_equalTo(self.logoImageView.mas_bottom).mas_offset(DN_SPACE(30));
    }];
    
    [self.subtitleLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerX.mas_equalTo(self);
        make.top.mas_equalTo(self.titleLabel.mas_bottom).mas_offset(DN_SPACE(10));
    }];
    
    [self.requirementButton mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerX.mas_equalTo(self);
        make.top.mas_equalTo(self.subtitleLabel.mas_bottom).mas_offset(DN_SPACE(30));
        make.height.mas_equalTo(DN_SPACE(45));
        make.width.mas_equalTo(DN_SPACE(120));
    }];
}
